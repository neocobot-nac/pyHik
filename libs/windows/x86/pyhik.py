...
_HCCore = _zlib1 = _YUVProcess = _SuperRender = _ssleay32 = _PlayCtrl = \
    _NPQos = _libeay32 = _HXVA = _hpr = _hlog = _GdiPlus = _AudioRender = _MP_Render = _EagleEyeRender = _MP_VIE = None

_HCNetSDK = None

def create():
    global _HCCore, _zlib1, _YUVProcess, _SuperRender, _ssleay32, _PlayCtrl, \
        _NPQos, _libeay32, _HXVA, _hpr, _hlog, _GdiPlus, _AudioRender, _MP_Render, _EagleEyeRender, _MP_VIE
    global _HCNetSDK
    ...
    _MP_VIE = WinDLL(os.path.join(__curdir__, 'MP_VIE.dll'))
...
def destory():
    ...
    win32api.FreeLibrary(_MP_VIE._handle)
